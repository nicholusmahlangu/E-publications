<footer id="footer" class="animate__animated animate__fadeInUp">
    <div class="container d-md-flex py-4">
        ...
        <div class="social-links text-center text-md-end pt-3 pt-md-0">
            <a href="https://www.facebook.com/NLSA" class="facebook" target="_blank"><i class="bi bi-facebook"></i></a>
            <a href="https://www.twitter.com/NLSA" class="twitter" target="_blank"><i class="bi bi-twitter"></i></a>
            <a href="https://www.instagram.com/NLSA" class="instagram" target="_blank"><i class="bi bi-instagram"></i></a>
